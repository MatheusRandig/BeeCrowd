...
def test_beginner1014_liter_km_two():
    result = beecrowd_1014.liter_km(2254,124.4,3)
    assert result == "18.119"

def test_beginner1014_liter_km_three():
